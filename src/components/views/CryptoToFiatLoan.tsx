...
const CryptoToFiatLoan = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success('Thank you!', {
      description: 'We\'ll notify you when Crypto to Fiat Loan is live.',
    });
    setEmail('');
  };
  ...
  return (
    <div className="w-full flex flex-col items-center gap-8">
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-lg leading-normal font-outfit font-normal text-[#4F4F4F]">Crypto to Fiat Loan is almost here. <br />Enter your email and we&apos;ll let you know the moment it&apos;s live.</p>
      </div>
